...
const Footer = () => {
  return (
    <footer className="bg-neutral-800 border-t shadow-sm px-6 py-10">
      <div className="flex gap-x-2 justify-center items-center">
        ...
        />
        <h2 className="text-2xl text-white/90 font-bold">Car House</h2>
      </div>
      ...
      <div className="flex flex-wrap md:gap-0 gap-5 md:justify-between justify-center items-center px-4">
          <p className="font-semibold md:text-left text-center text-white/90">Copyright © {new Date().getFullYear()} - All right reserved <br /> <span className="font-bold">by Car House Ltd.</span></p>
        ...
        <nav className="flex gap-3 items-center">
         ...
         <Link to="https://github.com/ssmahim01" target="_blank"><ImGithub className="text-2xl text-white/90" /></Link>
